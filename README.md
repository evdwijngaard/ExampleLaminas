This project is implementing the Liminas Tutorial Album example

I use this project to get familiar with the Liminas framework and components
I implemented the Album application using MySQL, NetBeans and MAMP
I shared my effort for those who want a working example of liminas

Below the original readme from the liminas mvc skeleton application 
